...
function tienenMismaLongitud(str1, str2) {
  ...
  // De lo contrario, devuelve "false"
  // Tu código:
  var palabra1 = str1.length;
  var palabra2 = str2.length;
...
function obtenerResto(x, y) {
  ...
  // Tu código:
  var RestoDivicion = x % y;
  return RestoDivicion;
}
...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código:
  var conbinarNombres = nombre + ' ' + apellido;
  return conbinarNombres;
}
